...
test_chrome_74_w10:
	mvn install -DLOCAL=true -Dos=Windows -Dos_version=10 -Dbrowser=chrome -Dbrowser_version=74.0 -Dresolution=1920x1080

test_chrome_74_w10:
	mvn install -DLOCAL=true -Dos=Windows -Dos_version=10 -Dbrowser=chrome -Dbrowser_version=74.0 -Dresolution=1920x1080

test_chrome_74_w81:
	mvn install -DLOCAL=true -Dos=Windows -Dos_version=8.1 -Dbrowser=chrome -Dbrowser_version=74.0 -Dresolution=1920x1080

test_chrome_73_w8:
	mvn install -DLOCAL=true -Dos=Windows -Dos_version=8 -Dbrowser=chrome -Dbrowser_version=73.0 -Dresolution=1920x1080

test_chrome_74_w7:
	mvn install -DLOCAL=true -Dos=Windows -Dos_version=7 -Dbrowser=chrome -Dbrowser_version=74.0 -Dresolution=1920x1080

test_chrome_74_osxmoj:
	mvn install -DLOCAL=true -Dos="OS X" -Dos_version=Mojave -Dbrowser=chrome -Dbrowser_version=74.0 -Dresolution=1920x1080

test_chrome_73_osxmoj:
	mvn install -DLOCAL=true -Dos="OS X" -Dos_version=Mojave -Dbrowser=chrome -Dbrowser_version=73.0 -Dresolution=1920x1080

test_chrome_74_osxhs:
	mvn install -DLOCAL=true -Dos="OS X" -Dos_version="High Sierra" -Dbrowser=chrome -Dbrowser_version=74.0 -Dresolution=1920x1080

test_chrome_74_osxs:
	mvn install -DLOCAL=true -Dos="OS X" -Dos_version=Sierra -Dbrowser=chrome -Dbrowser_version=74.0 -Dresolution=1920x1080

test_firefox_66_w10:
	mvn install -DLOCAL=true -Dos=Windows -Dos_version=10 -Dbrowser=Firefox -Dbrowser_version=66.0 -Dresolution=1920x1080

test_firefox_65_w81:
	mvn install -DLOCAL=true -Dos=Windows -Dos_version=8.1 -Dbrowser=Firefox -Dbrowser_version=65.0 -Dresolution=1920x1080

test_firefox_66_w7:
	mvn install -DLOCAL=true -Dos=Windows -Dos_version=7 -Dbrowser=Firefox -Dbrowser_version=66.0 -Dresolution=1920x1080

test_firefox_66_osxmoj:
	mvn install -DLOCAL=true -Dos="OS X" -Dos_version=Mojave -Dbrowser=Firefox -Dbrowser_version=66.0 -Dresolution=1920x1080
...
test_firefox_66_osxs:
	mvn install -DLOCAL=true -Dos="OS X" -Dos_version=Sierra -Dbrowser=Firefox -Dbrowser_version=66.0 -Dresolution=1920x1080
